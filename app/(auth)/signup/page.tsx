...
//       type: data.profileType?.toUpperCase(),
//       country: data.country,
//       avatar: avatarUrl, // ✅ Inclure l'URL de l'avatar
//     };
...
//             className="cursor-pointer bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white px-8 py-3 rounded-lg shadow-md transition"
//           >
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow-lg mt-10 animate-fade-in">
      ...
      >
        ...
        {/* ✅ AVATAR UPLOAD AVEC CALLBACK - isPublic=true pour l'inscription */}
        ...
        <div className="text-center">
          <button
            type="submit"
            disabled={registering}
            className="cursor-pointer bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-8 py-3 rounded-lg shadow-md transition transform hover:scale-105"
          >
            {registering ? "⏳ Création en cours..." : "🚀 Créer mon compte"}
          </button>
        </div>
