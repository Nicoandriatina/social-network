...
//           className="fixed bottom-8 right-8 z-50 w-14 h-14 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full shadow-2xl hover:shadow-indigo-500/50 hover:scale-110 transition-all duration-300 flex items-center justify-center group"
//         >
...
//                 <button
//                   onClick={handlePublishProject}
//                   className="w-full mt-6 px-4 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-medium hover:shadow-lg transition-all duration-300"
//                 >
...
//                 <p className="text-gray-500 mb-4">Il n'y a pas encore de projets dans cette catégorie.</p>
//                 {currentUser?.typeProfil === 'ETABLISSEMENT' && (
//                   <button
//                     onClick={handlePublishProject}
