...
import { Heart, MessageCircle, Share2, Send, Bookmark, MoreHorizontal, MapPin, Calendar, Users, TrendingUp, Plus, Trash2, Edit2, AlertTriangle, X, Loader2, CheckCircle2 } from 'lucide-react';
...
const MadaSocialFeed = () => {
  ...
  // Ouvrir le modal de confirmation de partage
  ...
  // Ouvrir le modal de confirmation de sauvegarde
