...
//   );
// }
// app/dashboard/donations/received/page.tsx - Version avec historique intégré
"use client";
...
export default function EnhancedDonationsReceivedPage() {
  ...
  // Filtrage des donations (même logique qu'avant)
  const filteredDonations = useMemo(() => {
    let filtered = donations;
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  ...
                  {activeView === 'history' && 'Historique complet des actions'}
                </p>
              </div>
            </div>
        ...
        {activeView === 'donations' ? (
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6">
            ...
            <div className="space-y-6">
              ...
              {/* Filtres (code existant pour les filtres) */}
              <div className={`bg-white rounded-2xl border border-slate-200 p-6 transition-all ${
                showFilters ? 'block' : 'hidden lg:block'
              }`}>
                <h3 className="font-semibold text-slate-800 mb-4">Filtres</h3>
            ...
            {/* Liste des donations (code existant) */}
            <div className="space-y-4">
              {filteredDonations.length === 0 ? (
                <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
                  <Package className="w-16 h-16 text-slate-400 mx-auto mb-4" />
