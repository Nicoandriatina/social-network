// app/api/donateurs/[id]/shared-projects/route.ts
...
export async function GET(
  ...
  try {
    ...
    console.log('📥 Récupération projets partagés par donateur ID:', id);
    ...
    console.error("GET /api/donateurs/[id]/shared-projects error:", error);
