...
// export const runtime = "nodejs"; // en haut du fichier
...
//       return NextResponse.json({error:"Email/mot de passe requis"},{status:400});
//     }

//     // Rechercher utilisateur par email ou téléphone
...
//     // ✅ Toujours JSON, jamais redirect ici
