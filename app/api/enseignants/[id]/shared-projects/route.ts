// app/api/enseignants/[id]/shared-projects/route.ts
...
export async function GET(
  ...
  try {
    ...
    console.log('📥 Récupération projets partagés par enseignant ID:', id);
    ...
    console.error("GET /api/enseignants/[id]/shared-projects error:", error);
