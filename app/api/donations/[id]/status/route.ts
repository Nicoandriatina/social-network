...
// import { onDonReceived } from "@/lib/updateProjectNeeds";
...
//               }
//             },
//             besoins: true // 🎯 Inclure les besoins pour la réponse
//           }
//         },
//         beneficiaireEtab: {
//           select: { 
...
//           }
//         },
//         need: true // 🎯 Inclure le besoin lié
//       }
//     });
...
//       console.log('🔍 Vérification permission ENVOYE:', {
...
//         console.log('🔍 Vérification permission RECEPTIONNE (personnel):', {
...
//       console.log('🔍 Vérification permission EN_ATTENTE:', {
//         isDonateur,
//         isProjectAuthor,
//         isEtabAdmin,
//         isPersonnel,
...
//               select: { nom: true } 
//             },
//             besoins: true // 🎯 Inclure les besoins mis à jour
//           }
//         },
//         beneficiaireEtab: {
//           select: { 
...
//     console.log('✅ Don mis à jour avec succès:', {
//       donId: updatedDon.id,
//       nouveauStatut: updatedDon.statut
//     });

//     // 🎯🎯🎯 MISE À JOUR DES JAUGES DE PROGRESSION
//     let gaugesUpdated = false;
//     if (status === 'RECEPTIONNE') {
//       try {
//         console.log(`\n🔄 DÉCLENCHEMENT MISE À JOUR JAUGES pour le don ${resolvedParams.id}`);
//         console.log(`   Type: ${don.type}`);
//         console.log(`   Montant: ${don.montant || 'N/A'}`);
//         console.log(`   Quantité: ${don.quantite || 'N/A'}`);
//         console.log(`   Besoin lié: ${don.needId || 'Aucun'}`);
//         console.log(`   Projet lié: ${don.projectId || 'Aucun'}`);
        
//         await onDonReceived(resolvedParams.id);
//         gaugesUpdated = true;
        
//         console.log(`✅ Jauges mises à jour avec succès\n`);
//       } catch (gaugeError) {
//         console.error('❌ Erreur lors de la mise à jour des jauges:', gaugeError);
//         // On continue quand même, l'important est que le statut soit mis à jour
//       }
//     }
...
//             type: 'DONATION_RECEIVED_CONFIRMED',
...
//           metadata: {
//             oldStatus: don.statut,
//             newStatus: status,
//             updatedBy: payload.userId,
//             gaugesUpdated // 🎯 Indiquer si les jauges ont été mises à jour
//           }
//         }
//       });
//     } catch (logError) {
//       console.error('⚠️ Erreur log activité (non bloquant):', logError);
//     }

//     return NextResponse.json({ 
//       message: "Statut mis à jour avec succès",
//       donation: updatedDon,
//       gaugesUpdated // 🎯 Informer le frontend que les jauges ont été mises à jour
//     });
...
//             besoins: true // 🎯 Inclure les besoins pour voir la progression
//           }
//         },
//         beneficiaireEtab: {
//           select: { nom: true }
      ...
      if (status === 'ENVOYE') {
        ...
        if (recipientId && recipientId !== don.donateurId) {
          const notification = await prisma.notification.create({
            data: {
              userId: recipientId,
              type: 'DONATION_RECEIVED', // ✅ Type existant dans votre enum
              title: 'Don en cours d\'acheminement',
              content: `Le don "${don.libelle}" a été envoyé et est en cours d'acheminement`,
              donId: don.id,
              relatedUserId: don.donateurId,
