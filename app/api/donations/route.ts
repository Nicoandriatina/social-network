...
//   // ✅ NOUVEAU CHAMP : Raison du don (optionnel)
//   raison: z.string().max(1000, "La raison ne doit pas dépasser 1000 caractères").optional(),
...
// // POST - Créer un nouveau don avec support des articles multiples et raison
...
//     // Créer le don avec les articles et la raison
...
//         photos: data.photos || [],
//         raison: data.raison || null, // ✅ Ajout de la raison
//         statut: 'EN_ATTENTE',
...
//           raison: data.raison // ✅ Inclure la raison dans les metadata
//         }
//       });
//     } else {
...
//         raison: data.raison // ✅ Inclure la raison
//       });
//     }
...
// // GET - Récupérer les dons de l'utilisateur connecté avec les articles et raison
...
//         items: items,
//         raison: don.raison, // ✅ Inclure la raison
//         statut: don.statut,
//         photos: don.photos,
