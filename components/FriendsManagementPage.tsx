...
// import { UserPlus, Check, X, Search, Users, Clock, Eye } from 'lucide-react';
...
//                         className="flex-1 px-3 py-2 bg-slate-50 text-slate-600 rounded-lg hover:bg-slate-100 transition-colors text-sm font-medium"
//                       >
//                         Message
//                       </button>
//                     </div>
...
//                     </div>
//                     <Link
//                       href={`/dashboard/profile/${request.from.id}`}
//                       className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-indigo-50 text-indigo-600 rounded-lg hover:bg-indigo-100 transition-colors text-sm font-medium"
//                     >
//                       <Eye size={16} />
//                       Voir profil
//                     </Link>
...
//   );
// }
// components/FriendsManagementPage.tsx
'use client';
