...
// components/ProfilComponent/DashboardEtab.tsx - VERSION AMÉLIORÉE
"use client";
...
export default function EtabDashboard({ user }: { user: FrontUser }) {
  ...
  // États pour les projets enrichis
  ...
  // Enrichir les projets avec les détails (besoins)
  useEffect(() => {
    if (activeTab === "projets" && projects.length > 0) {
      enrichProjectsWithDetails();
    }
  }, [activeTab, projects]);
  ...
  const enrichProjectsWithDetails = async () => {
    ...
    try {
        ...
        projects.map(async (project) => {
          try {
            ...
            if (response.ok) {
              ...
              return {
                ...project,
                besoins: data.project.besoins || [],
                progressionGlobale: data.project.progressionGlobale || 0
              };
            }
          } catch (error) {
      ...
      console.error('Erreur enrichissement projets:', error);
          ...
          {filteredTeachers.map((teacher) => (
            ...
            >
              ...
              <div className="pt-4 border-t border-slate-200">
                <Link
                  href={`/dashboard/profile/${teacher.user.id}`}
                  className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 font-medium"
                >
      ...
      default:
        return (
          <div className="p-6">
            ...
            {!loading && !loadingProjectDetails && !error && (
                    ...
                    <div key={project.id} className="rounded-2xl border border-slate-200 bg-white p-5 hover:shadow-lg transition-all duration-300">
                      ...
                      <div className="flex items-center justify-between pt-4 mt-4 border-t border-slate-200">
                        <div className="flex items-center gap-4 text-sm">
                          ...
                          <span className="flex items-center gap-1.5 text-green-600 font-semibold" title={`${formatFullAmount(project.totalRaised)} Ar`}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 grid grid-cols-1 lg:grid-cols-[280px_1fr_320px] gap-6">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 text-center shadow-sm">
                ...
                <div className="grid grid-cols-3 gap-3 mt-5">
                  ...
                  <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-3">
                    <div className="text-lg font-bold text-amber-600" title={`${formatFullAmount(donationStats?.totalMonetaire || 0)} Ar`}>
        ...
        <main className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
          <div className="max-h-[calc(100vh-6rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100">
            {/* Header / Tabs - Sticky */}
            <div className="px-6 py-5 border-b border-slate-200 bg-gradient-to-br from-indigo-50 to-purple-50 sticky top-0 z-10">
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white p-6 shadow-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center">
                    <div className="text-2xl font-bold" title={`${formatFullAmount((donationStats?.montantThisMonth || 0))} Ar`}>
                      {loadingDonations ? "..." : formatAmount((donationStats?.montantThisMonth || 0))}
                    </div>
                    <div className="text-xs opacity-90">Ar ce mois</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center">
                    <div className="text-2xl font-bold">
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center p-2 bg-green-50 rounded-lg">
                      ...
                      <span className="font-semibold text-green-600" title={`${formatFullAmount(donationStats.totalMonetaire)} Ar`}>
                    ...
                    <div className="flex justify-between items-center p-2 bg-yellow-50 rounded-lg">
                      ...
                      <span className="font-semibold text-yellow-600" title={`${formatFullAmount(donationStats.montantEnAttente)} Ar`}>
                    ...
                    <div className="flex justify-between items-center p-2 bg-emerald-50 rounded-lg">
                      ...
                      <span className="font-semibold text-emerald-600" title={`${formatFullAmount(donationStats.montantRecu)} Ar`}>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                ...
                {!loading && enrichedProjects.slice(0, 4).map((project) => (
